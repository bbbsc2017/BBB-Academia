...
import { InlineAudioPlayer, formatTime } from '@components/Objects/StyledElements/AudioPlayer/InlineAudioPlayer'
...
// ─── Inline Audio Player ───
// Extracted to components/Objects/StyledElements/AudioPlayer/InlineAudioPlayer.tsx
// (imported above) so it can be reused outside the editor — e.g. assignment
// reference-file playback — without pulling in this file's TipTap/editor deps.
