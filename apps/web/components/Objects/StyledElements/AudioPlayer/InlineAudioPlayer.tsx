...
// Brand accent — matches the color already used to re-theme the course video
// player (see components/Objects/Activities/Video/player-controls.css).
const ACCENT = '#00a9bf'
...
/**
 * Extensions accepted as playable audio wherever a plain filename is all
 * that's available (e.g. an assignment task's reference_file string) —
 * mirrors the audio keys in lib/constants.ts's ACCEPTED_FILE_FORMATS.
 */
...
/**
 * Self-contained inline audio player (no editor/context dependencies) —
 * shared by the content editor's audio block, podcasts, and any other place
 * that just needs to play a single audio file with a UI consistent with the
 * rest of the site.
 */
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="px-4 py-3 flex items-center gap-3">
        ...
        <button
          onClick={togglePlay}
          className="rounded-full p-2.5 transition-colors outline-none"
        ...
        >
          ...
          <div
            ...
            style={{ left: `calc(${progress}% - 6px)`, backgroundColor: ACCENT }}
          />
        </div>
